...
<header>
	...
	<c:if test="${pageContext.request.userPrincipal.name != null}">
		...
		<div id="gradient">
			<form class="searchbox" action="searchQues">
				<input type="search" name="searchText" placeholder="Search" required
					style="color: black; -webkit-appearance: none;" />
				<button id="search" type="submit" value="search">&nbsp;</button>
			</form>
		</div>
	</c:if>
